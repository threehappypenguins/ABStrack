...
/**
 * Practitioner TOTP MFA enrollment and session verification (`/mfa`).
 * Root `/` redirects to the patient workspace; invite and login flows send
 * password accounts here when no verified factor exists yet.
 *
...
export default function MfaEnrollmentPage() {
  ...
  return (
    <div id="practitioner-mfa" className="mx-auto max-w-2xl px-4 py-8 sm:px-6">
